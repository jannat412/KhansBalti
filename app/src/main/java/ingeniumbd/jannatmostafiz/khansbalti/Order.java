...
public class Order extends AppCompatActivity {
    ...
    EditText editTextName, editTextItem, editTextQuantity, editTextMessage,editTextPhone,editTextEmail;
    Button buttonSend;
    Session session;
        ...
        buttonSend.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(editTextName.getText().toString() )){
                    Toast.makeText(Order.this,"Please enter name",Toast.LENGTH_LONG).show();
                    return;
                }
                if(TextUtils.isEmpty(editTextItem.getText().toString() )){
                    Toast.makeText(Order.this,"Please enter food item number",Toast.LENGTH_LONG).show();
                    return;
                }
                if(TextUtils.isEmpty(editTextQuantity.getText().toString() )){
                    Toast.makeText(Order.this,"Please enter food quantity",Toast.LENGTH_LONG).show();
                    return;
                }
                if(TextUtils.isEmpty(editTextMessage.getText().toString() )){
                    Toast.makeText(Order.this,"Please enter your message",Toast.LENGTH_LONG).show();
                    return;
                }
                if(TextUtils.isEmpty(editTextPhone.getText().toString() )){
                    Toast.makeText(Order.this,"Please enter phone number",Toast.LENGTH_LONG).show();
                    return;
                }
                if(TextUtils.isEmpty(editTextEmail.getText().toString() )){
                    Toast.makeText(Order.this,"Please enter email",Toast.LENGTH_LONG).show();
                    return;
                }else {
    ...
    private void openprogresdialog() {
        ...
        final ProgressDialog progDailog = ProgressDialog.show(
                Order.this, "Sending mail", "Please wait...", true);
                ...
                try {
                    ...
                    try{
                        ...
                        if(session != null){
                            ...
                            message.setSubject("Order from Application");
                            ...
                            message.setContent("Name: " + editTextName.getText().toString() + "\n\n"
                                    + "Item number: " + editTextItem.getText().toString()+ "\n\n"
                                    + "Quantity: "+ editTextQuantity.getText().toString()+ "\n\n"
                                    + "Order message: "+ editTextMessage.getText().toString()+ "\n\n"
